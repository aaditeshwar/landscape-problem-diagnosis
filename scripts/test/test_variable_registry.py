...
from services.assembler import VARIABLE_RESOLVERS, resolve_variable  # noqa: E402
...
def test_drought_causality_normalization():
    raw = {
        "2020": {
            "severe_moderate": {"moderate_drought_path3": 5.0},
            "mild": {
...
def test_static_cd_expression_rewrite():
    ...
    assert patched == "cd_total_urbanization_ha > 20"
    assert notes
