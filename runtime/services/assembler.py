...
_BASE_VARIABLE_RESOLVERS: dict[str, Any] = {
    ...
    **_change_detection_resolvers(),
    ...
    "monsoon_onset_delay_first_year_days": lambda m: resolve_derived(m, "monsoon_onset_delay_first_year_days"),
    "monsoon_onset_delay_lag3_days": lambda m: resolve_derived(m, "monsoon_onset_delay_lag3_days"),
    "monsoon_onset_latest_doy": lambda m: resolve_derived(m, "monsoon_onset_latest_doy"),
    "lulc_cropland_latest_ha": lambda m: resolve_derived(m, "lulc_cropland_latest_ha"),
